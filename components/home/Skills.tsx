...
function SkillsPage() {
  return (
    <div className="flex flex-col px-4 md:px-8 py-4 md:flex-row shadow-xl bg-gradient-to-br from-fun-card via-transparent to-fun-card backdrop-blur-sm border-2 border-fun-border rounded-xl justify-between relative">
