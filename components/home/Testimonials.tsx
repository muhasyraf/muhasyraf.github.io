...
function TestimonialsPage() {
  return (
    <div className="flex flex-col text-left max-w-md md:max-w-full w-full m-auto">
      <SectionTitle title="Check my Precious Blog!" />
        ...
        {Testimonials.map((item, index) => {
          return (
            <div
              ...
              className={`relative ${
                index === 2 ? "z-[10]" : ""
              } bg-fun-pink-darker border border-fun-pink-light p-5 rounded-lg h-full flex flex-col justify-between`}
            >
              ...
              {index === 2 && (
                <img
                  className="absolute z-[-10] top-[-30px] right-[-15px] w-11"
