...
export default function Hero() {
  return (
    <div className="flex flex-col justify-center lg:justify-end gap-6 w-full rounded-lg bg-fun-card border-2 border-fun-border lg:h-[65dvh] my-2 sm:my-4 px-2 sm:px-4 shadow-lg">
